    ...
    <ul class="nav navbar-nav ml-auto">
        <div class="dropdown">
            <li class="nav-item d-md-down-none dropdown">
                ...
                <a class="dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-bell"></i></a>
               <?php
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <button class="btn-outline-dark"> <?php echo $this->session->userdata('user_email'); ?></button>
            </a>
